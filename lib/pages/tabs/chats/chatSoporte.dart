...
import 'package:pacientes/pages/preguntasFrecuentes.dart';
...
class ChatSoporte extends StatelessWidget {
  ...
  ChatSoporte(
      {Key key,
        this.documentDoctorID,
        this.doctorAvatar,
        this.documentPacienteID,
        this.nombre})
      : super(key: key);
...
class ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    groupChatId = '${widget.peerId}-${widget.peerActual}';
  ...
  Future<void> onSendMessage(String content, int type) async {
    ...
    if (content.trim() != '') {
      ...
      if(nuevoChat){
        Firestore.instance.collection('chatSoporteP').add({'paciente':widget.peerActual,'timestamp': DateTime.now().millisecondsSinceEpoch.toString(),});
      }
